...
@section('content')
<h2 class="text-center"> Selamat datang di Website Kompresi & Dekompresi</h2>
...
Cras odio est, porttitor vitae ullamcorper non, dignissim nec augue. Nulla eget lorem vulputate, luctus est eu, tristique diam. Nam porttitor sapien sapien, vel tempor eros consectetur sit amet. In neque magna, tristique at rhoncus vel, ultrices ut urna. Nulla facilisi. Nam in pellentesque arcu, sed tempus dui. Mauris finibus imperdiet dui, sed fermentum augue congue luctus.
...
<div class="text-center">
  <a href="compress" class="btn btn-primary">Compress</a>  |  <a href="compress" class="btn btn-info">Decompress</a>
